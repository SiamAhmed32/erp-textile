            ...
            <DialogContent className="sm:max-w-[425px] py-21 ">
                ...
                {step === "EMAIL" && (
                    <form onSubmit={handleEmailSubmit} className="space-y-4 pt-4">
                        ...
                        />
                        <Button type="submit" className="w-full bg-secondary" disabled={isSendingEmail}>
                ...
                {step === "OTP" && (
                    <form onSubmit={handleOTPSubmit} className="space-y-4 pt-4">
                        ...
                        />
                        <Button type="submit" className="w-full bg-secondary" disabled={isVerifyingOTP}>
                ...
                {step === "RESET" && (
                    <form onSubmit={handleResetSubmit} className="space-y-4 pt-4">
                        ...
                        <Button type="submit" className="w-full bg-secondary" disabled={isResettingPassword}>
