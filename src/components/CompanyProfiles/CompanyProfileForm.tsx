...
export function CompanyProfileForm({ data, onChange, isEditing, errors = {} }: Props) {
  return (
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              <Label htmlFor="tradeLicenseExpiryDate">Trade License Expiry</Label>
              <Input
                id="tradeLicenseExpiryDate"
                type="date"
                value={data.tradeLicenseExpiryDate}
                onChange={(e) => onChange("tradeLicenseExpiryDate", e.target.value)}
                readOnly={!isEditing}
              />
              {errors.tradeLicenseExpiryDate && (
                <p className="text-xs text-destructive">{errors.tradeLicenseExpiryDate}</p>
              )}
            </div>
          </div>
        </CardContent>
