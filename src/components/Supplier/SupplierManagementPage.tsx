...
export function SupplierManagementPage() {
    ...
    const [formData, setFormData] = React.useState<SupplierFormData>(emptySupplier);
    ...
    const totalPages = (suppliersPayload as any)?.meta?.pagination?.totalPages || 1;
    ...
    React.useEffect(() => {
        ...
        toast.error(`Error loading suppliers: ${message}`);
    }, [suppliersError]);
    ...
    const handleFormChange = (field: keyof SupplierFormData, value: string | number) => {
    ...
    const handleFormSubmit = async () => {
        ...
        try {
            const payload = {
                ...
                openingLiability: formData.openingLiability ? Number(formData.openingLiability) : undefined,
            };
