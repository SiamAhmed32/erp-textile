...
import { ChevronDown, ArrowUpDown, Plus } from "lucide-react";
...
export default function BankToolbar({
    ...
    const sortOptions = [
        { value: "bankName_asc", label: "Bank Name A - Z", field: "bankName", dir: "asc" },
        { value: "bankName_desc", label: "Bank Name Z - A", field: "bankName", dir: "desc" },
                    ...
                    <DropdownMenuTrigger asChild>
                        <Button
                            ...
                            className={cn(
                                ...
                                sort !== null && "bg-purple-50 border-purple-200 text-purple-700",
                            )}
                        >
