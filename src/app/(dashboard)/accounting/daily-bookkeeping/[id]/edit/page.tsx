...
> = {
  BUYER_DUE: {
    label: "Buyer Due",
    icon: Bookmark,
    desc: "Sales revenue and buyer obligation.",
  },
  RECEIPT: {
    label: "Receipt",
    icon: Receipt,
    desc: "Payment received from a buyer.",
  },
  SUPPLIER_DUE: {
    label: "Supplier Due",
    icon: Building,
    desc: "Purchase expense and supplier obligation.",
  },
  PAYMENT: {
    label: "Payment",
    icon: Send,
    desc: "Payment sent to a supplier.",
  },
  JOURNAL: {
    label: "Journal",
    icon: FileText,
    desc: "General adjustment entry.",
  },
  CONTRA: {
    label: "Contra",
    icon: Undo2,
    desc: "Transfer between cash and bank accounts.",
  },
};
                        ...
                        <div className="flex rounded-lg overflow-hidden border border-zinc-200">
                          {(["DEBIT", "CREDIT"] as const).map((side) => (
                            <button
                              ...
                              type="button"
                              onClick={() =>
                                setValue(`lines.${index}.type`, side)
                              }
                              className={cn(
          ...
          <div className="bg-zinc-50 border border-zinc-200 rounded-xl p-5">
            <div className="flex items-start gap-3">
              ...
              <p className="text-xs text-zinc-500 leading-relaxed">
                Only <span className="font-semibold text-zinc-700">DRAFT</span>{" "}
                entries can be edited. Once posted, create a{" "}
                <span className="font-semibold text-zinc-700">Reversal</span>{" "}
                entry instead.
              </p>
            </div>
          </div>
