    ...
    const handleExportPdf = React.useCallback(() => {
        ...
        if (order.productType === "FABRIC" && item.fabricItem) {
            ...
            if (rows.length) {
                autoTable(doc, {
                    startY,
                    head: [["Color", "Net Weight", "Gross Weight", "Qty (Yds)", "Unit Price", "Total"]],
        ...
        <Container className="pb-10 pt-6">
            <Flex className="flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="flex flex-wrap gap-2 mb-4 lg:mb-8">
                    ...
                    <Button variant="outline" onClick={() => order && router.push(`/order-management/orders/add-new-order?duplicateId=${order.id}`)} disabled={!order}>
