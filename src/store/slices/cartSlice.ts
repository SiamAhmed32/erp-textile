 ...
 * 
 * This is an example implementation of a shopping cart for e-commerce applications.
 * You can use this as a reference, modify it for your needs, or remove it entirely
 * if your application doesn't require cart functionality.
 * 
 * Key Features:
 * - Add/remove items with quantity management
 * - Support for product variations (size, color)
 * - Stock validation
 * - Automatic total calculations (subtotal, VAT, shipping)
